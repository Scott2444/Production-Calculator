...
type AttributeEditorMode = "create" | "edit";

export interface AttributeEditorDialogProps {
...
export default function AttributeEditorDialog({
    ...
    return (
        <Popup
            ...
            title={isCreate ? "Add attribute" : "Edit attribute"}
            description={
                isCreate
                    ? "Create a new attribute in this project."
