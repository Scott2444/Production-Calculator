namespace ProductionCalculator.Business.Models
{
	public class WorkflowProductNode
	{
		...
		public required double Actual_Flow_Rate_In { get; set; }
        public required double Actual_Flow_Rate_Out { get; set; }
		...
		public bool ValueEquals(WorkflowProductNode other)
		{
			...
			return Workflow_Product_Node_Id == other.Workflow_Product_Node_Id
				...
				&& Actual_Flow_Rate_In == other.Actual_Flow_Rate_In
                && Actual_Flow_Rate_Out == other.Actual_Flow_Rate_Out
                && Is_External == other.Is_External;
		}

		public override int GetHashCode()
		{
			return HashCode.Combine(Workflow_Product_Node_Id, Workflow_Id, Product_Id, Calculated_Flow_Rate, Actual_Flow_Rate_In, Actual_Flow_Rate_Out, Is_External);
		}
	}
}
