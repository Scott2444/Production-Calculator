...
namespace ProductionCalculator.Business.Services
{
	public class WorkflowNodeService : IWorkflowNodeService
	{
		...
		public WorkflowNodeService(IWorkflowNodeRepository nodeRepo, IWorkflowTargetRepository targetRepo, IWorkflowNodeModifierRepository modifierRepo, IWorkflowEdgeRepository edgeRepo)
		{
			_nodeRepo = nodeRepo;
